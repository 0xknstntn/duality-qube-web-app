...
var Message = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      pex_request: (0, _helpers.isSet)(object.pex_request) ? PexRequest.fromJSON(object.pex_request) : undefined,
      pex_addrs: (0, _helpers.isSet)(object.pex_addrs) ? PexAddrs.fromJSON(object.pex_addrs) : undefined
    };
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseMessage();
