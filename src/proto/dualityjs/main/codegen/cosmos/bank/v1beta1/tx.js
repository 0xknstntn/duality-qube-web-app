...
var MsgSetSendEnabled = {
  encode: function encode(message) {
    ...
    var _iterator5 = _createForOfIteratorHelper(message.use_default_for),
      _step5;
    try {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      use_default_for: Array.isArray(object === null || object === void 0 ? void 0 : object.use_default_for) ? object.use_default_for.map(function (e) {
        return String(e);
      }) : []
    };
  },
  fromPartial: function fromPartial(object) {
    ...
    message.use_default_for = ((_object$use_default_f = object.use_default_for) === null || _object$use_default_f === void 0 ? void 0 : _object$use_default_f.map(function (e) {
      return e;
    })) || [];
    return message;
  }
