...
var GenesisState = {
  encode: function encode(message) {
    ...
    var _iterator3 = _createForOfIteratorHelper(message.denom_metadata),
      _step3;
    try {
    ...
    var _iterator4 = _createForOfIteratorHelper(message.send_enabled),
      _step4;
    try {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.denom_metadata.push(_bank.Metadata.decode(reader, reader.uint32()));
          break;
        case 5:
          message.send_enabled.push(_bank.SendEnabled.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      denom_metadata: Array.isArray(object === null || object === void 0 ? void 0 : object.denom_metadata) ? object.denom_metadata.map(function (e) {
        return _bank.Metadata.fromJSON(e);
      }) : [],
      send_enabled: Array.isArray(object === null || object === void 0 ? void 0 : object.send_enabled) ? object.send_enabled.map(function (e) {
        return _bank.SendEnabled.fromJSON(e);
      }) : []
    };
  },
  fromPartial: function fromPartial(object) {
    ...
    message.denom_metadata = ((_object$denom_metadat = object.denom_metadata) === null || _object$denom_metadat === void 0 ? void 0 : _object$denom_metadat.map(function (e) {
      return _bank.Metadata.fromPartial(e);
    })) || [];
    message.send_enabled = ((_object$send_enabled = object.send_enabled) === null || _object$send_enabled === void 0 ? void 0 : _object$send_enabled.map(function (e) {
