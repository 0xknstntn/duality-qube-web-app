...
var QueryDenomOwnersResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator5 = _createForOfIteratorHelper(message.denom_owners),
      _step5;
    try {
  ...
  fromJSON: function fromJSON(object) {
    return {
      denom_owners: Array.isArray(object === null || object === void 0 ? void 0 : object.denom_owners) ? object.denom_owners.map(function (e) {
  ...
  fromPartial: function fromPartial(object) {
    ...
    var message = createBaseQueryDenomOwnersResponse();
    message.denom_owners = ((_object$denom_owners = object.denom_owners) === null || _object$denom_owners === void 0 ? void 0 : _object$denom_owners.map(function (e) {
...
var QuerySendEnabledResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator7 = _createForOfIteratorHelper(message.send_enabled),
      _step7;
    try {
