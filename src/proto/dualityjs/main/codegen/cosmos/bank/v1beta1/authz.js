...
var SendAuthorization = {
  encode: function encode(message) {
    ...
    var _iterator2 = _createForOfIteratorHelper(message.allow_list),
      _step2;
    try {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      allow_list: Array.isArray(object === null || object === void 0 ? void 0 : object.allow_list) ? object.allow_list.map(function (e) {
        return String(e);
      }) : []
    };
  },
  fromPartial: function fromPartial(object) {
    ...
    message.allow_list = ((_object$allow_list = object.allow_list) === null || _object$allow_list === void 0 ? void 0 : _object$allow_list.map(function (e) {
      return e;
    })) || [];
    return message;
  }
