      ...
      var _balance = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(params) {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              endpoint = "cosmos/nft/v1beta1/balance/".concat(params.owner, "/").concat(params.class_id);
              _context.t0 = _query.QueryBalanceResponse;
              _context.next = 4;
      ...
      var _owner = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(params) {
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              endpoint = "cosmos/nft/v1beta1/owner/".concat(params.class_id, "/").concat(params.id);
              _context2.t0 = _query.QueryOwnerResponse;
              _context2.next = 4;
              return this.req.get(endpoint);
            case 4:
      ...
      var _supply = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(params) {
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              endpoint = "cosmos/nft/v1beta1/supply/".concat(params.class_id);
              _context3.t0 = _query.QuerySupplyResponse;
              _context3.next = 4;
              return this.req.get(endpoint);
            case 4:
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.t0 = _query.QueryNFTsResponse;
              _context4.next = 8;
      ...
      var _nFT = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(params) {
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              endpoint = "cosmos/nft/v1beta1/nfts/".concat(params.class_id, "/").concat(params.id);
              _context5.t0 = _query.QueryNFTResponse;
              _context5.next = 4;
              return this.req.get(endpoint);
            case 4:
      ...
      var _class2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(params) {
        ...
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              endpoint = "cosmos/nft/v1beta1/classes/".concat(params.class_id);
              _context6.t0 = _query.QueryClassResponse;
              _context6.next = 4;
              return this.req.get(endpoint);
            case 4:
        ...
        return _regenerator["default"].wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.t0 = _query.QueryClassesResponse;
              _context7.next = 7;
              return this.req.get(endpoint, options);
            case 7:
