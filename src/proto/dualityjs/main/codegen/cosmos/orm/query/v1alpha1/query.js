...
var GetRequest = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      message_name: (0, _helpers.isSet)(object.message_name) ? String(object.message_name) : "",
...
var GetResponse = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      result: (0, _helpers.isSet)(object.result) ? _any.Any.fromJSON(object.result) : undefined
    };
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseGetResponse();
...
var ListRequest = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      message_name: (0, _helpers.isSet)(object.message_name) ? String(object.message_name) : "",
      index: (0, _helpers.isSet)(object.index) ? String(object.index) : "",
      prefix: (0, _helpers.isSet)(object.prefix) ? ListRequest_Prefix.fromJSON(object.prefix) : undefined,
      range: (0, _helpers.isSet)(object.range) ? ListRequest_Range.fromJSON(object.range) : undefined,
...
var ListRequest_Range = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      start: Array.isArray(object === null || object === void 0 ? void 0 : object.start) ? object.start.map(function (e) {
        return IndexValue.fromJSON(e);
      }) : [],
      end: Array.isArray(object === null || object === void 0 ? void 0 : object.end) ? object.end.map(function (e) {
        return IndexValue.fromJSON(e);
      }) : []
    };
  },
...
var IndexValue = {
  encode: function encode(message) {
    ...
    if (message.timestamp !== undefined) {
      _timestamp.Timestamp.encode(message.timestamp, writer.uint32(58).fork()).ldelim();
    }
  ...
  fromJSON: function fromJSON(object) {
    return {
      uint: (0, _helpers.isSet)(object.uint) ? _helpers.Long.fromValue(object.uint) : undefined,
      "int": (0, _helpers.isSet)(object["int"]) ? _helpers.Long.fromValue(object["int"]) : undefined,
      str: (0, _helpers.isSet)(object.str) ? String(object.str) : undefined,
      bytes: (0, _helpers.isSet)(object.bytes) ? (0, _helpers.bytesFromBase64)(object.bytes) : undefined,
      "enum": (0, _helpers.isSet)(object["enum"]) ? String(object["enum"]) : undefined,
      bool: (0, _helpers.isSet)(object.bool) ? Boolean(object.bool) : undefined,
