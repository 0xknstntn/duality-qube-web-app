        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.t0 = _query.QueryAccountsResponse;
              _context.next = 7;
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.t0 = _query.QueryAccountResponse;
              _context2.next = 4;
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.t0 = _query.QueryAccountAddressByIDResponse;
              _context3.next = 6;
              return this.req.get(endpoint, options);
            case 6:
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.t0 = _query.QueryParamsResponse;
              _context4.next = 5;
              return this.req.get(endpoint);
            case 5:
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.t0 = _query.QueryModuleAccountsResponse;
              _context5.next = 5;
              return this.req.get(endpoint);
            case 5:
        ...
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.t0 = _query.QueryModuleAccountByNameResponse;
              _context6.next = 4;
              return this.req.get(endpoint);
            case 4:
        ...
        return _regenerator["default"].wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.t0 = _query.Bech32PrefixResponse;
              _context7.next = 5;
              return this.req.get(endpoint);
            case 5:
      ...
      var _addressBytesToString = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(params) {
        ...
        return _regenerator["default"].wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              endpoint = "cosmos/auth/v1beta1/bech32/".concat(params.address_bytes);
              _context8.t0 = _query.AddressBytesToStringResponse;
              _context8.next = 4;
              return this.req.get(endpoint);
            case 4:
      ...
      var _addressStringToBytes = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(params) {
        ...
        return _regenerator["default"].wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              endpoint = "cosmos/auth/v1beta1/bech32/".concat(params.address_string);
              _context9.t0 = _query.AddressStringToBytesResponse;
              _context9.next = 4;
              return this.req.get(endpoint);
            case 4:
        ...
        return _regenerator["default"].wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.t0 = _query.QueryAccountInfoResponse;
              _context10.next = 4;
              return this.req.get(endpoint);
            case 4:
