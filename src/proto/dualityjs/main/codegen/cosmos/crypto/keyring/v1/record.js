...
var Record_Local = {
  encode: function encode(message) {
    ...
    if (message.priv_key !== undefined) {
      _any.Any.encode(message.priv_key, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.priv_key = _any.Any.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      priv_key: (0, _helpers.isSet)(object.priv_key) ? _any.Any.fromJSON(object.priv_key) : undefined
    };
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseRecord_Local();
    message.priv_key = object.priv_key !== undefined && object.priv_key !== null ? _any.Any.fromPartial(object.priv_key) : undefined;
    return message;
  }
};
