        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.t0 = _query.QueryCurrentPlanResponse;
              _context.next = 5;
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.t0 = _query.QueryAppliedPlanResponse;
              _context2.next = 4;
              return this.req.get(endpoint);
            case 4:
      ...
      var _upgradedConsensusState = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(params) {
        ...
        return _regenerator["default"].wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              endpoint = "cosmos/upgrade/v1beta1/upgraded_consensus_state/".concat(params.last_height);
              _context3.t0 = _query.QueryUpgradedConsensusStateResponse;
              _context3.next = 4;
              return this.req.get(endpoint);
            case 4:
        ...
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.t0 = _query.QueryModuleVersionsResponse;
              _context4.next = 6;
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.t0 = _query.QueryAuthorityResponse;
              _context5.next = 5;
              return this.req.get(endpoint);
            case 5:
