...
function createBaseGenesisOwners() {
  return {
    ...
    index_owners: _capability.CapabilityOwners.fromPartial({})
  };
}
var GenesisOwners = {
  encode: function encode(message) {
    ...
    if (message.index_owners !== undefined) {
      _capability.CapabilityOwners.encode(message.index_owners, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.index_owners = _capability.CapabilityOwners.decode(reader, reader.uint32());
          break;
        default:
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      index_owners: (0, _helpers.isSet)(object.index_owners) ? _capability.CapabilityOwners.fromJSON(object.index_owners) : undefined
    };
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseGenesisOwners();
    message.index = object.index !== undefined && object.index !== null ? _helpers.Long.fromValue(object.index) : _helpers.Long.UZERO;
    message.index_owners = object.index_owners !== undefined && object.index_owners !== null ? _capability.CapabilityOwners.fromPartial(object.index_owners) : undefined;
    return message;
  }
};
