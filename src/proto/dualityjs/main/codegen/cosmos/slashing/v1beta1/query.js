...
var QuerySigningInfoRequest = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      cons_address: (0, _helpers.isSet)(object.cons_address) ? String(object.cons_address) : ""
    };
  },
  fromPartial: function fromPartial(object) {
...
function createBaseQuerySigningInfoResponse() {
  return {
    val_signing_info: _slashing.ValidatorSigningInfo.fromPartial({})
  };
}
var QuerySigningInfoResponse = {
  encode: function encode(message) {
    ...
    if (message.val_signing_info !== undefined) {
      _slashing.ValidatorSigningInfo.encode(message.val_signing_info, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.val_signing_info = _slashing.ValidatorSigningInfo.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      val_signing_info: (0, _helpers.isSet)(object.val_signing_info) ? _slashing.ValidatorSigningInfo.fromJSON(object.val_signing_info) : undefined
    };
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQuerySigningInfoResponse();
    message.val_signing_info = object.val_signing_info !== undefined && object.val_signing_info !== null ? _slashing.ValidatorSigningInfo.fromPartial(object.val_signing_info) : undefined;
    return message;
  }
};
