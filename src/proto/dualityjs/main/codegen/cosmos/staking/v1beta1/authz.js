...
function createBaseStakeAuthorization() {
  return {
    max_tokens: _coin.Coin.fromPartial({}),
...
var StakeAuthorization = {
  encode: function encode(message) {
    ...
    if (message.max_tokens !== undefined) {
      _coin.Coin.encode(message.max_tokens, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.max_tokens = _coin.Coin.decode(reader, reader.uint32());
          break;
        case 2:
  ...
  fromJSON: function fromJSON(object) {
    return {
      max_tokens: (0, _helpers.isSet)(object.max_tokens) ? _coin.Coin.fromJSON(object.max_tokens) : undefined,
      allow_list: (0, _helpers.isSet)(object.allow_list) ? StakeAuthorization_Validators.fromJSON(object.allow_list) : undefined,
      deny_list: (0, _helpers.isSet)(object.deny_list) ? StakeAuthorization_Validators.fromJSON(object.deny_list) : undefined,
      authorization_type: (0, _helpers.isSet)(object.authorization_type) ? authorizationTypeFromJSON(object.authorization_type) : -1
    };
  },
  fromPartial: function fromPartial(object) {
    var _object$authorization;
    var message = createBaseStakeAuthorization();
    message.max_tokens = object.max_tokens !== undefined && object.max_tokens !== null ? _coin.Coin.fromPartial(object.max_tokens) : undefined;
