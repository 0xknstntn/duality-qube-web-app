...
var MsgClientImpl = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(MsgClientImpl, [{
    key: "auctionBid",
    value: function auctionBid(request) {
      var data = _tx.MsgAuctionBid.encode(request).finish();
      var promise = this.rpc.request("pob.builder.v1.Msg", "AuctionBid", data);
      return promise.then(function (data) {
        return _tx.MsgAuctionBidResponse.decode(new _m0.Reader(data));
      });
    }
  }, {
    key: "updateParams",
    value: function updateParams(request) {
      ...
      var promise = this.rpc.request("pob.builder.v1.Msg", "UpdateParams", data);
      return promise.then(function (data) {
