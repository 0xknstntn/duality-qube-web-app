...
var ScalarDescriptor = {
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.field_type),
      _step;
    try {
  ...
  fromJSON: function fromJSON(object) {
    return {
      name: (0, _helpers.isSet)(object.name) ? String(object.name) : "",
      description: (0, _helpers.isSet)(object.description) ? String(object.description) : "",
      field_type: Array.isArray(object === null || object === void 0 ? void 0 : object.field_type) ? object.field_type.map(function (e) {
        return scalarTypeFromJSON(e);
      }) : []
    };
  },
  fromPartial: function fromPartial(object) {
    var _object$name2, _object$description2, _object$field_type;
    var message = createBaseScalarDescriptor();
    message.name = (_object$name2 = object.name) !== null && _object$name2 !== void 0 ? _object$name2 : "";
    message.description = (_object$description2 = object.description) !== null && _object$description2 !== void 0 ? _object$description2 : "";
    message.field_type = ((_object$field_type = object.field_type) === null || _object$field_type === void 0 ? void 0 : _object$field_type.map(function (e) {
      return e;
    })) || [];
    return message;
  }
