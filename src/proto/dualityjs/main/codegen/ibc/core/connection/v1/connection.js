...
var ConnectionEnd = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      delay_period: (0, _helpers.isSet)(object.delay_period) ? _helpers.Long.fromValue(object.delay_period) : _helpers.Long.UZERO
    };
  },
...
var Params = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      max_expected_time_per_block: (0, _helpers.isSet)(object.max_expected_time_per_block) ? _helpers.Long.fromValue(object.max_expected_time_per_block) : _helpers.Long.UZERO
    };
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseParams();
