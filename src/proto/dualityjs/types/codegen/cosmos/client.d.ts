...
export declare const cosmosAminoConverters: {
    "/cosmos.vesting.v1beta1.MsgCreateVestingAccount": {
        aminoType: string;
        toAmino: ({ from_address, to_address, amount, end_time, delayed }: import("./vesting/v1beta1/tx").MsgCreateVestingAccount) => {
            from_address: string;
            to_address: string;
            amount: {
                denom: string;
    ...
    "/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccount": {
        aminoType: string;
        toAmino: ({ from_address, to_address, amount }: import("./vesting/v1beta1/tx").MsgCreatePermanentLockedAccount) => {
            from_address: string;
            to_address: string;
            amount: {
                denom: string;
    ...
    "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount": {
        aminoType: string;
        toAmino: ({ from_address, to_address, start_time, vesting_periods }: import("./vesting/v1beta1/tx").MsgCreatePeriodicVestingAccount) => {
            from_address: string;
            to_address: string;
            start_time: string;
            vesting_periods: {
    ...
    "/cosmos.staking.v1beta1.MsgCreateValidator": {
        aminoType: string;
        toAmino: ({ description, commission, min_self_delegation, delegator_address, validator_address, pubkey, value }: import("./staking/v1beta1/tx").MsgCreateValidator) => {
            description: {
                moniker: string;
                identity: string;
                website: string;
    ...
    "/cosmos.staking.v1beta1.MsgEditValidator": {
        aminoType: string;
        toAmino: ({ description, validator_address, commission_rate, min_self_delegation }: import("./staking/v1beta1/tx").MsgEditValidator) => {
            description: {
                moniker: string;
                identity: string;
                website: string;
    ...
    "/cosmos.staking.v1beta1.MsgDelegate": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address, amount }: import("./staking/v1beta1/tx").MsgDelegate) => {
            delegator_address: string;
            validator_address: string;
            amount: {
                denom: string;
    ...
    "/cosmos.staking.v1beta1.MsgBeginRedelegate": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_src_address, validator_dst_address, amount }: import("./staking/v1beta1/tx").MsgBeginRedelegate) => {
            delegator_address: string;
    ...
    "/cosmos.staking.v1beta1.MsgUndelegate": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address, amount }: import("./staking/v1beta1/tx").MsgUndelegate) => {
            delegator_address: string;
            validator_address: string;
            amount: {
                denom: string;
    ...
    "/cosmos.staking.v1beta1.MsgCancelUnbondingDelegation": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address, amount, creation_height }: import("./staking/v1beta1/tx").MsgCancelUnbondingDelegation) => {
            delegator_address: string;
            validator_address: string;
            amount: {
                denom: string;
    ...
    "/cosmos.slashing.v1beta1.MsgUnjail": {
        aminoType: string;
        toAmino: ({ validator_addr }: import("./slashing/v1beta1/tx").MsgUnjail) => {
    ...
    "/cosmos.nft.v1beta1.MsgSend": {
        aminoType: string;
        toAmino: ({ class_id, id, sender, receiver }: import("./nft/v1beta1/tx").MsgSend) => {
            class_id: string;
            id: string;
            sender: string;
            receiver: string;
    ...
    "/cosmos.group.v1.MsgUpdateGroupMembers": {
        aminoType: string;
        toAmino: ({ admin, group_id, member_updates }: import("./group/v1/tx").MsgUpdateGroupMembers) => {
            admin: string;
            group_id: string;
            member_updates: {
                address: string;
    ...
    "/cosmos.group.v1.MsgUpdateGroupAdmin": {
        aminoType: string;
        toAmino: ({ admin, group_id, new_admin }: import("./group/v1/tx").MsgUpdateGroupAdmin) => {
            admin: string;
            group_id: string;
            new_admin: string;
        };
    ...
    "/cosmos.group.v1.MsgUpdateGroupMetadata": {
        aminoType: string;
        toAmino: ({ admin, group_id, metadata }: import("./group/v1/tx").MsgUpdateGroupMetadata) => {
            admin: string;
            group_id: string;
            metadata: string;
        };
    ...
    "/cosmos.group.v1.MsgCreateGroupPolicy": {
        aminoType: string;
        toAmino: ({ admin, group_id, metadata, decision_policy }: import("./group/v1/tx").MsgCreateGroupPolicy) => {
            admin: string;
            group_id: string;
            metadata: string;
            decision_policy: {
    ...
    "/cosmos.group.v1.MsgCreateGroupWithPolicy": {
        aminoType: string;
        toAmino: ({ admin, members, group_metadata, group_policy_metadata, group_policy_as_admin, decision_policy }: import("./group/v1/tx").MsgCreateGroupWithPolicy) => {
            admin: string;
            members: {
                address: string;
                weight: string;
    ...
    "/cosmos.group.v1.MsgUpdateGroupPolicyAdmin": {
        aminoType: string;
        toAmino: ({ admin, group_policy_address, new_admin }: import("./group/v1/tx").MsgUpdateGroupPolicyAdmin) => {
            admin: string;
    ...
    "/cosmos.group.v1.MsgUpdateGroupPolicyDecisionPolicy": {
        aminoType: string;
        toAmino: ({ admin, group_policy_address, decision_policy }: import("./group/v1/tx").MsgUpdateGroupPolicyDecisionPolicy) => {
            admin: string;
            group_policy_address: string;
            decision_policy: {
                type_url: string;
    ...
    "/cosmos.group.v1.MsgUpdateGroupPolicyMetadata": {
        aminoType: string;
        toAmino: ({ admin, group_policy_address, metadata }: import("./group/v1/tx").MsgUpdateGroupPolicyMetadata) => {
            admin: string;
            group_policy_address: string;
            metadata: string;
        };
    ...
    "/cosmos.group.v1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ group_policy_address, proposers, metadata, messages, exec, title, summary }: import("./group/v1/tx").MsgSubmitProposal) => {
            group_policy_address: string;
            proposers: string[];
            metadata: string;
            messages: {
    ...
    "/cosmos.group.v1.MsgWithdrawProposal": {
        aminoType: string;
        toAmino: ({ proposal_id, address }: import("./group/v1/tx").MsgWithdrawProposal) => {
            proposal_id: string;
            address: string;
        };
    ...
    "/cosmos.group.v1.MsgVote": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, option, metadata, exec }: import("./group/v1/tx").MsgVote) => {
            proposal_id: string;
            voter: string;
            option: number;
            metadata: string;
    ...
    "/cosmos.group.v1.MsgExec": {
        aminoType: string;
        toAmino: ({ proposal_id, executor }: import("./group/v1/tx").MsgExec) => {
            proposal_id: string;
            executor: string;
        };
    ...
    "/cosmos.group.v1.MsgLeaveGroup": {
        aminoType: string;
        toAmino: ({ address, group_id }: import("./group/v1/tx").MsgLeaveGroup) => {
            address: string;
            group_id: string;
        };
    ...
    "/cosmos.gov.v1beta1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ content, initial_deposit, proposer }: import("./gov/v1beta1/tx").MsgSubmitProposal) => {
            content: {
                type_url: string;
                value: Uint8Array;
            };
    ...
    "/cosmos.gov.v1beta1.MsgVote": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, option }: import("./gov/v1beta1/tx").MsgVote) => {
            proposal_id: string;
            voter: string;
            option: number;
        };
    ...
    "/cosmos.gov.v1beta1.MsgVoteWeighted": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, options }: import("./gov/v1beta1/tx").MsgVoteWeighted) => {
            proposal_id: string;
            voter: string;
            options: {
                option: number;
    ...
    "/cosmos.gov.v1beta1.MsgDeposit": {
        aminoType: string;
        toAmino: ({ proposal_id, depositor, amount }: import("./gov/v1beta1/tx").MsgDeposit) => {
            proposal_id: string;
            depositor: string;
            amount: {
                denom: string;
    ...
    "/cosmos.gov.v1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ messages, initial_deposit, proposer, metadata, title, summary }: import("./gov/v1/tx").MsgSubmitProposal) => {
            messages: {
                type_url: string;
                value: Uint8Array;
            }[];
    ...
    "/cosmos.gov.v1.MsgVote": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, option, metadata }: import("./gov/v1/tx").MsgVote) => {
            proposal_id: string;
            voter: string;
            option: number;
            metadata: string;
    ...
    "/cosmos.gov.v1.MsgVoteWeighted": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, options, metadata }: import("./gov/v1/tx").MsgVoteWeighted) => {
            proposal_id: string;
            voter: string;
            options: {
                option: number;
    ...
    "/cosmos.gov.v1.MsgDeposit": {
        aminoType: string;
        toAmino: ({ proposal_id, depositor, amount }: import("./gov/v1/tx").MsgDeposit) => {
            proposal_id: string;
            depositor: string;
            amount: {
                denom: string;
    ...
    "/cosmos.distribution.v1beta1.MsgSetWithdrawAddress": {
        aminoType: string;
        toAmino: ({ delegator_address, withdraw_address }: import("./distribution/v1beta1/tx").MsgSetWithdrawAddress) => {
            delegator_address: string;
    ...
    "/cosmos.distribution.v1beta1.MsgWithdrawDelegatorReward": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address }: import("./distribution/v1beta1/tx").MsgWithdrawDelegatorReward) => {
            delegator_address: string;
            validator_address: string;
        };
    ...
    "/cosmos.distribution.v1beta1.MsgWithdrawValidatorCommission": {
        aminoType: string;
        toAmino: ({ validator_address }: import("./distribution/v1beta1/tx").MsgWithdrawValidatorCommission) => {
            validator_address: string;
        };
    ...
    "/cosmos.crisis.v1beta1.MsgVerifyInvariant": {
        aminoType: string;
        toAmino: ({ sender, invariant_module_name, invariant_route }: import("./crisis/v1beta1/tx").MsgVerifyInvariant) => {
            sender: string;
    ...
    "/cosmos.crisis.v1beta1.MsgUpdateParams": {
        aminoType: string;
        toAmino: ({ authority, constant_fee }: import("./crisis/v1beta1/tx").MsgUpdateParams) => {
            authority: string;
            constant_fee: {
                denom: string;
                amount: string;
    ...
    "/cosmos.bank.v1beta1.MsgSend": {
        aminoType: string;
        toAmino: ({ from_address, to_address, amount }: import("./bank/v1beta1/tx").MsgSend) => {
            from_address: string;
            to_address: string;
            amount: {
                denom: string;
    ...
    "/cosmos.bank.v1beta1.MsgSetSendEnabled": {
        aminoType: string;
        toAmino: ({ authority, send_enabled, use_default_for }: import("./bank/v1beta1/tx").MsgSetSendEnabled) => {
            authority: string;
            send_enabled: {
                denom: string;
                enabled: boolean;
    ...
    "/cosmos.authz.v1beta1.MsgRevoke": {
        aminoType: string;
        toAmino: ({ granter, grantee, msg_type_url }: import("./authz/v1beta1/tx").MsgRevoke) => {
            granter: string;
            grantee: string;
            msg_type_url: string;
        };
