...
export declare const AminoConverter: {
    "/cosmos.bank.v1beta1.MsgSend": {
        aminoType: string;
        toAmino: ({ from_address, to_address, amount }: MsgSend) => MsgSendAminoType["value"];
    ...
    "/cosmos.bank.v1beta1.MsgSetSendEnabled": {
        aminoType: string;
        toAmino: ({ authority, send_enabled, use_default_for }: MsgSetSendEnabled) => MsgSetSendEnabledAminoType["value"];
