...
export declare const AminoConverter: {
    "/cosmos.gov.v1beta1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ content, initial_deposit, proposer }: MsgSubmitProposal) => MsgSubmitProposalAminoType["value"];
        fromAmino: ({ content, initial_deposit, proposer }: MsgSubmitProposalAminoType["value"]) => MsgSubmitProposal;
    };
    "/cosmos.gov.v1beta1.MsgVote": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, option }: MsgVote) => MsgVoteAminoType["value"];
        fromAmino: ({ proposal_id, voter, option }: MsgVoteAminoType["value"]) => MsgVote;
    };
    "/cosmos.gov.v1beta1.MsgVoteWeighted": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, options }: MsgVoteWeighted) => MsgVoteWeightedAminoType["value"];
