...
export declare const AminoConverter: {
    "/cosmos.gov.v1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ messages, initial_deposit, proposer, metadata, title, summary }: MsgSubmitProposal) => MsgSubmitProposalAminoType["value"];
    ...
    "/cosmos.gov.v1.MsgVote": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, option, metadata }: MsgVote) => MsgVoteAminoType["value"];
        fromAmino: ({ proposal_id, voter, option, metadata }: MsgVoteAminoType["value"]) => MsgVote;
    };
    "/cosmos.gov.v1.MsgVoteWeighted": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, options, metadata }: MsgVoteWeighted) => MsgVoteWeightedAminoType["value"];
        fromAmino: ({ proposal_id, voter, options, metadata }: MsgVoteWeightedAminoType["value"]) => MsgVoteWeighted;
    };
    "/cosmos.gov.v1.MsgDeposit": {
        aminoType: string;
        toAmino: ({ proposal_id, depositor, amount }: MsgDeposit) => MsgDepositAminoType["value"];
