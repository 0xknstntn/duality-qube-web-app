...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
     ...
     * Since: cosmos-sdk 0.46.2
     */
    useAccountAddressByID: <TData_2 = QueryAccountAddressByIDResponse>({ request, options }: UseAccountAddressByIDQuery<TData_2>) => import("@tanstack/react-query").UseQueryResult<TData_2, Error>;
    /** Params queries all parameters. */ useParams: <TData_3 = QueryParamsResponse>({ request, options }: UseParamsQuery<TData_3>) => import("@tanstack/react-query").UseQueryResult<TData_3, Error>;
    /**
     * ModuleAccounts returns all the existing module accounts.
     *
     * Since: cosmos-sdk 0.46
     */
    useModuleAccounts: <TData_4 = QueryModuleAccountsResponse>({ request, options }: UseModuleAccountsQuery<TData_4>) => import("@tanstack/react-query").UseQueryResult<TData_4, Error>;
    /** ModuleAccountByName returns the module account info by module name */ useModuleAccountByName: <TData_5 = QueryModuleAccountByNameResponse>({ request, options }: UseModuleAccountByNameQuery<TData_5>) => import("@tanstack/react-query").UseQueryResult<TData_5, Error>;
    /**
     * Bech32Prefix queries bech32Prefix
     *
     * Since: cosmos-sdk 0.46
     */
    useBech32Prefix: <TData_6 = Bech32PrefixResponse>({ request, options }: UseBech32PrefixQuery<TData_6>) => import("@tanstack/react-query").UseQueryResult<TData_6, Error>;
    /**
     * AddressBytesToString converts Account Address bytes to string
     *
     * Since: cosmos-sdk 0.46
     */
    useAddressBytesToString: <TData_7 = AddressBytesToStringResponse>({ request, options }: UseAddressBytesToStringQuery<TData_7>) => import("@tanstack/react-query").UseQueryResult<TData_7, Error>;
    /**
     * AddressStringToBytes converts Address string to bytes
     *
     * Since: cosmos-sdk 0.46
     */
    useAddressStringToBytes: <TData_8 = AddressStringToBytesResponse>({ request, options }: UseAddressStringToBytesQuery<TData_8>) => import("@tanstack/react-query").UseQueryResult<TData_8, Error>;
    /**
     * AccountInfo queries account info which is common to all account types.
     *
     * Since: cosmos-sdk 0.47
     */
    useAccountInfo: <TData_9 = QueryAccountInfoResponse>({ request, options }: UseAccountInfoQuery<TData_9>) => import("@tanstack/react-query").UseQueryResult<TData_9, Error>;
};
