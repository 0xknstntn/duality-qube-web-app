...
export declare const AminoConverter: {
    ...
    "/cosmos.group.v1.MsgUpdateGroupMembers": {
        aminoType: string;
        toAmino: ({ admin, group_id, member_updates }: MsgUpdateGroupMembers) => MsgUpdateGroupMembersAminoType["value"];
        fromAmino: ({ admin, group_id, member_updates }: MsgUpdateGroupMembersAminoType["value"]) => MsgUpdateGroupMembers;
    };
    "/cosmos.group.v1.MsgUpdateGroupAdmin": {
        aminoType: string;
        toAmino: ({ admin, group_id, new_admin }: MsgUpdateGroupAdmin) => MsgUpdateGroupAdminAminoType["value"];
        fromAmino: ({ admin, group_id, new_admin }: MsgUpdateGroupAdminAminoType["value"]) => MsgUpdateGroupAdmin;
    };
    "/cosmos.group.v1.MsgUpdateGroupMetadata": {
        aminoType: string;
        toAmino: ({ admin, group_id, metadata }: MsgUpdateGroupMetadata) => MsgUpdateGroupMetadataAminoType["value"];
        fromAmino: ({ admin, group_id, metadata }: MsgUpdateGroupMetadataAminoType["value"]) => MsgUpdateGroupMetadata;
    };
    "/cosmos.group.v1.MsgCreateGroupPolicy": {
        aminoType: string;
        toAmino: ({ admin, group_id, metadata, decision_policy }: MsgCreateGroupPolicy) => MsgCreateGroupPolicyAminoType["value"];
        fromAmino: ({ admin, group_id, metadata, decision_policy }: MsgCreateGroupPolicyAminoType["value"]) => MsgCreateGroupPolicy;
    };
    "/cosmos.group.v1.MsgCreateGroupWithPolicy": {
        aminoType: string;
        toAmino: ({ admin, members, group_metadata, group_policy_metadata, group_policy_as_admin, decision_policy }: MsgCreateGroupWithPolicy) => MsgCreateGroupWithPolicyAminoType["value"];
    ...
    "/cosmos.group.v1.MsgUpdateGroupPolicyAdmin": {
        aminoType: string;
        toAmino: ({ admin, group_policy_address, new_admin }: MsgUpdateGroupPolicyAdmin) => MsgUpdateGroupPolicyAdminAminoType["value"];
    ...
    "/cosmos.group.v1.MsgUpdateGroupPolicyDecisionPolicy": {
        aminoType: string;
        toAmino: ({ admin, group_policy_address, decision_policy }: MsgUpdateGroupPolicyDecisionPolicy) => MsgUpdateGroupPolicyDecisionPolicyAminoType["value"];
    ...
    "/cosmos.group.v1.MsgUpdateGroupPolicyMetadata": {
        aminoType: string;
        toAmino: ({ admin, group_policy_address, metadata }: MsgUpdateGroupPolicyMetadata) => MsgUpdateGroupPolicyMetadataAminoType["value"];
    ...
    "/cosmos.group.v1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ group_policy_address, proposers, metadata, messages, exec, title, summary }: MsgSubmitProposal) => MsgSubmitProposalAminoType["value"];
    ...
    "/cosmos.group.v1.MsgWithdrawProposal": {
        aminoType: string;
        toAmino: ({ proposal_id, address }: MsgWithdrawProposal) => MsgWithdrawProposalAminoType["value"];
        fromAmino: ({ proposal_id, address }: MsgWithdrawProposalAminoType["value"]) => MsgWithdrawProposal;
    };
    "/cosmos.group.v1.MsgVote": {
        aminoType: string;
        toAmino: ({ proposal_id, voter, option, metadata, exec }: MsgVote) => MsgVoteAminoType["value"];
        fromAmino: ({ proposal_id, voter, option, metadata, exec }: MsgVoteAminoType["value"]) => MsgVote;
    };
    "/cosmos.group.v1.MsgExec": {
        aminoType: string;
        toAmino: ({ proposal_id, executor }: MsgExec) => MsgExecAminoType["value"];
        fromAmino: ({ proposal_id, executor }: MsgExecAminoType["value"]) => MsgExec;
    };
    "/cosmos.group.v1.MsgLeaveGroup": {
        aminoType: string;
        toAmino: ({ address, group_id }: MsgLeaveGroup) => MsgLeaveGroupAminoType["value"];
