...
export declare const AminoConverter: {
    "/cosmos.staking.v1beta1.MsgCreateValidator": {
        aminoType: string;
        toAmino: ({ description, commission, min_self_delegation, delegator_address, validator_address, pubkey, value }: MsgCreateValidator) => MsgCreateValidatorAminoType["value"];
    ...
    "/cosmos.staking.v1beta1.MsgEditValidator": {
        aminoType: string;
        toAmino: ({ description, validator_address, commission_rate, min_self_delegation }: MsgEditValidator) => MsgEditValidatorAminoType["value"];
    ...
    "/cosmos.staking.v1beta1.MsgDelegate": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address, amount }: MsgDelegate) => MsgDelegateAminoType["value"];
        fromAmino: ({ delegator_address, validator_address, amount }: MsgDelegateAminoType["value"]) => MsgDelegate;
    };
    "/cosmos.staking.v1beta1.MsgBeginRedelegate": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_src_address, validator_dst_address, amount }: MsgBeginRedelegate) => MsgBeginRedelegateAminoType["value"];
    ...
    "/cosmos.staking.v1beta1.MsgUndelegate": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address, amount }: MsgUndelegate) => MsgUndelegateAminoType["value"];
        fromAmino: ({ delegator_address, validator_address, amount }: MsgUndelegateAminoType["value"]) => MsgUndelegate;
    };
    "/cosmos.staking.v1beta1.MsgCancelUnbondingDelegation": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address, amount, creation_height }: MsgCancelUnbondingDelegation) => MsgCancelUnbondingDelegationAminoType["value"];
