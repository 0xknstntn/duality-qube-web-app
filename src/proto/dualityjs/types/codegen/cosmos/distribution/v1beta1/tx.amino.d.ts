...
export declare const AminoConverter: {
    "/cosmos.distribution.v1beta1.MsgSetWithdrawAddress": {
        aminoType: string;
        toAmino: ({ delegator_address, withdraw_address }: MsgSetWithdrawAddress) => MsgSetWithdrawAddressAminoType["value"];
        fromAmino: ({ delegator_address, withdraw_address }: MsgSetWithdrawAddressAminoType["value"]) => MsgSetWithdrawAddress;
    };
    "/cosmos.distribution.v1beta1.MsgWithdrawDelegatorReward": {
        aminoType: string;
        toAmino: ({ delegator_address, validator_address }: MsgWithdrawDelegatorReward) => MsgWithdrawDelegatorRewardAminoType["value"];
    ...
    "/cosmos.distribution.v1beta1.MsgWithdrawValidatorCommission": {
        aminoType: string;
        toAmino: ({ validator_address }: MsgWithdrawValidatorCommission) => MsgWithdrawValidatorCommissionAminoType["value"];
