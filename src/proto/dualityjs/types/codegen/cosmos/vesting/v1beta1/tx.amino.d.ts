...
export declare const AminoConverter: {
    "/cosmos.vesting.v1beta1.MsgCreateVestingAccount": {
        aminoType: string;
        toAmino: ({ from_address, to_address, amount, end_time, delayed }: MsgCreateVestingAccount) => MsgCreateVestingAccountAminoType["value"];
    ...
    "/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccount": {
        aminoType: string;
        toAmino: ({ from_address, to_address, amount }: MsgCreatePermanentLockedAccount) => MsgCreatePermanentLockedAccountAminoType["value"];
    ...
    "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount": {
        aminoType: string;
        toAmino: ({ from_address, to_address, start_time, vesting_periods }: MsgCreatePeriodicVestingAccount) => MsgCreatePeriodicVestingAccountAminoType["value"];
