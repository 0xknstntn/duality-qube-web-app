...
export declare namespace router {
    const v1: {
        ...
        createRpcQueryHooks: (rpc: import("@cosmjs/stargate").ProtobufRpcClient) => {
            useParams: <TData = _163.QueryParamsResponse>({ request, options }: _314.UseParamsQuery<TData>) => import("@tanstack/react-query").UseQueryResult<TData, Error>;
        };
        ...
        GenesisState_InFlightPacketsEntry: {
            encode(message: _162.GenesisState_InFlightPacketsEntry, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
            decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _162.GenesisState_InFlightPacketsEntry;
            fromJSON(object: any): _162.GenesisState_InFlightPacketsEntry;
            fromPartial(object: {
                key?: string;
                value?: {
                    ...
                    packet_timeout_timestamp?: string | number | import("long").default;
                    packet_timeout_height?: string;
                    packet_data?: Uint8Array;
                    refund_sequence?: string | number | import("long").default;
                    retries_remaining?: number;
                    timeout?: string | number | import("long").default;
                    nonrefundable?: boolean;
                };
            }): _162.GenesisState_InFlightPacketsEntry;
        };
        GenesisState: {
        ...
        InFlightPacket: {
            encode(message: _162.InFlightPacket, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
            decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _162.InFlightPacket;
            fromJSON(object: any): _162.InFlightPacket;
            fromPartial(object: {
                original_sender_address?: string;
                refund_channel_id?: string;
                refund_port_id?: string;
