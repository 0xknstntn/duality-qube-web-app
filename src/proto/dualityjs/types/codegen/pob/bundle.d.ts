...
export declare namespace pob {
    namespace builder {
        namespace module {
            const v1: {
                Module: {
                    encode(message: _158.Module, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                    decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _158.Module;
        ...
        const v1: {
            ...
            createRpcQueryHooks: (rpc: import("@cosmjs/stargate").ProtobufRpcClient) => {
                useParams: <TData = _160.QueryParamsResponse>({ request, options }: _311.UseParamsQuery<TData>) => import("@tanstack/react-query").UseQueryResult<TData, Error>;
            };
            ...
            MessageComposer: {
                encoded: {
                    auctionBid(value: _161.MsgAuctionBid): {
                        typeUrl: string;
                        value: Uint8Array;
                    };
            ...
            AminoConverter: {
                "/pob.builder.v1.MsgAuctionBid": {
                    aminoType: string;
                    toAmino: ({ bidder, bid, transactions }: _161.MsgAuctionBid) => {
                        bidder: string;
                        bid: {
                            denom: string;
                            amount: string;
                ...
                "/pob.builder.v1.MsgUpdateParams": {
                    aminoType: string;
                    toAmino: ({ authority, params }: _161.MsgUpdateParams) => {
                        authority: string;
                        params: {
                    ...
                    }) => _161.MsgUpdateParams;
                };
            };
            MsgAuctionBid: {
                encode(message: _161.MsgAuctionBid, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _161.MsgAuctionBid;
                fromJSON(object: any): _161.MsgAuctionBid;
                fromPartial(object: {
                    bidder?: string;
                    bid?: {
                        denom?: string;
            ...
            MsgAuctionBidResponse: {
                encode(_: _161.MsgAuctionBidResponse, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _161.MsgAuctionBidResponse;
                fromJSON(_: any): _161.MsgAuctionBidResponse;
                fromPartial(_: {}): _161.MsgAuctionBidResponse;
            };
            MsgUpdateParams: {
                encode(message: _161.MsgUpdateParams, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _161.MsgUpdateParams;
            ...
            MsgUpdateParamsResponse: {
                encode(_: _161.MsgUpdateParamsResponse, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
                decode(input: Uint8Array | import("protobufjs").Reader, length?: number): _161.MsgUpdateParamsResponse;
                fromJSON(_: any): _161.MsgUpdateParamsResponse;
                fromPartial(_: {}): _161.MsgUpdateParamsResponse;
            };
            QueryParamsRequest: {
