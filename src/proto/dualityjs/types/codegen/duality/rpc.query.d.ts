...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    duality: {
        ...
        incentives: {
            getModuleStatus(request?: import("./incentives/query").GetModuleStatusRequest): Promise<import("./incentives/query").GetModuleStatusResponse>;
            getGaugeByID(request: import("./incentives/query").GetGaugeByIDRequest): Promise<import("./incentives/query").GetGaugeByIDResponse>;
            getGauges(request: import("./incentives/query").GetGaugesRequest): Promise<import("./incentives/query").GetGaugesResponse>;
            getStakeByID(request: import("./incentives/query").GetStakeByIDRequest): Promise<import("./incentives/query").GetStakeByIDResponse>;
            getStakes(request: import("./incentives/query").GetStakesRequest): Promise<import("./incentives/query").GetStakesResponse>;
            getFutureRewardEstimate(request: import("./incentives/query").GetFutureRewardEstimateRequest): Promise<import("./incentives/query").GetFutureRewardEstimateResponse>;
            getAccountHistory(request: import("./incentives/query").GetAccountHistoryRequest): Promise<import("./incentives/query").GetAccountHistoryResponse>;
            getGaugeQualifyingValue(request: import("./incentives/query").GetGaugeQualifyingValueRequest): Promise<import("./incentives/query").GetGaugeQualifyingValueResponse>;
        };
    };
}>;
