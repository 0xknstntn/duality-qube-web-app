...
export const ServiceCommandDescriptor = {
  ...
  fromJSON(object: any): ServiceCommandDescriptor {
    return {
      ...
      rpc_command_options: Array.isArray(object?.rpc_command_options) ? object.rpc_command_options.map((e: any) => RpcCommandOptions.fromJSON(e)) : [],
      sub_commands: isObject(object.sub_commands) ? Object.entries(object.sub_commands).reduce<{
        [key: string]: ServiceCommandDescriptor;
      }>((acc, [key, value]) => {
...
export const RpcCommandOptions = {
  ...
  fromJSON(object: any): RpcCommandOptions {
    return {
      ...
      flag_options: isObject(object.flag_options) ? Object.entries(object.flag_options).reduce<{
        [key: string]: FlagOptions;
      }>((acc, [key, value]) => {
        acc[key] = FlagOptions.fromJSON(value);
        return acc;
      }, {}) : {},
      positional_args: Array.isArray(object?.positional_args) ? object.positional_args.map((e: any) => PositionalArgDescriptor.fromJSON(e)) : [],
