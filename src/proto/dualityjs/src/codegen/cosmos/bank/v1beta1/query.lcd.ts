...
export class LCDQueryClient {
  ...
  async spendableBalanceByDenom(params: QuerySpendableBalanceByDenomRequest): Promise<QuerySpendableBalanceByDenomResponse> {
    const options: any = {
      params: {}
    };
    if (typeof params?.denom !== "undefined") {
  ...
  /* SendEnabled queries for SendEnabled entries.
   ...
   Since: cosmos-sdk 0.47 */
  async sendEnabled(params: QuerySendEnabledRequest): Promise<QuerySendEnabledResponse> {
    const options: any = {
      params: {}
    };
