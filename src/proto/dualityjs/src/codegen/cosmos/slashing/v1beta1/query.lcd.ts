...
export class LCDQueryClient {
  ...
  async signingInfo(params: QuerySigningInfoRequest): Promise<QuerySigningInfoResponse> {
    ...
    return QuerySigningInfoResponse.fromJSON(await this.req.get<QuerySigningInfoResponse>(endpoint));
  }
  ...
  async signingInfos(params: QuerySigningInfosRequest = {
    ...
    return QuerySigningInfosResponse.fromJSON(await this.req.get<QuerySigningInfosResponse>(endpoint, options));
  }
}