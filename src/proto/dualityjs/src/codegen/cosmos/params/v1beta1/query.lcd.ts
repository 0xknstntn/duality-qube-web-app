...
export class LCDQueryClient {
  ...
  async params(params: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    return QueryParamsResponse.fromJSON(await this.req.get<QueryParamsResponse>(endpoint, options));
  }
  ...
  async subspaces(_params: QuerySubspacesRequest = {}): Promise<QuerySubspacesResponse> {
    ...
    return QuerySubspacesResponse.fromJSON(await this.req.get<QuerySubspacesResponse>(endpoint));
  }
}