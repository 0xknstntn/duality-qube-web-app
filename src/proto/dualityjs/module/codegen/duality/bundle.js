...
export let duality;
(function (_duality) {
  const dex = _duality.dex = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _116), _117), _118), _119), _120), _121), _122), _123), _124), _125), _126), _127), _128), _129), _285), _287), _289), _292), _295);
  const epochs = _duality.epochs = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _130), _131), _290), _293);
  const incentives = _duality.incentives = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _132), _133), _134), _135), _136), _137), _138), _286), _288), _291), _294), _296);
  const ClientFactory = _duality.ClientFactory = _objectSpread(_objectSpread(_objectSpread({}, _321), _322), _323);
})(duality || (duality = {}));