...
import { QueryParamsResponse, QuerySubspacesResponse } from "./query";
export class LCDQueryClient {
  ...
  async params(params) {
    ...
    return QueryParamsResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async subspaces(_params = {}) {
    ...
    return QuerySubspacesResponse.fromJSON(await this.req.get(endpoint));
  }
}