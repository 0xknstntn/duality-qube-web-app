...
import { QueryParamsResponse, QueryValidatorDistributionInfoResponse, QueryValidatorOutstandingRewardsResponse, QueryValidatorCommissionResponse, QueryValidatorSlashesResponse, QueryDelegationRewardsResponse, QueryDelegationTotalRewardsResponse, QueryDelegatorValidatorsResponse, QueryDelegatorWithdrawAddressResponse, QueryCommunityPoolResponse } from "./query";
export class LCDQueryClient {
  ...
  async validatorDistributionInfo(params) {
    ...
    return QueryValidatorDistributionInfoResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async validatorOutstandingRewards(params) {
    ...
    return QueryValidatorOutstandingRewardsResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async validatorCommission(params) {
    ...
    return QueryValidatorCommissionResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async validatorSlashes(params) {
    ...
    return QueryValidatorSlashesResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async delegationRewards(params) {
    ...
    return QueryDelegationRewardsResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async delegationTotalRewards(params) {
    ...
    return QueryDelegationTotalRewardsResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async delegatorValidators(params) {
    ...
    return QueryDelegatorValidatorsResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async delegatorWithdrawAddress(params) {
    ...
    return QueryDelegatorWithdrawAddressResponse.fromJSON(await this.req.get(endpoint));
  }
  /* CommunityPool queries the community pool coins. */
  async communityPool(_params = {}) {
    const endpoint = `cosmos/distribution/v1beta1/community_pool`;
    return QueryCommunityPoolResponse.fromJSON(await this.req.get(endpoint));
  }
}