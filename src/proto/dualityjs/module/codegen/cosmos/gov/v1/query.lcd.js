...
import { QueryProposalResponse, QueryProposalsResponse, QueryVoteResponse, QueryVotesResponse, QueryParamsResponse, QueryDepositResponse, QueryDepositsResponse, QueryTallyResultResponse } from "./query";
export class LCDQueryClient {
  ...
  async proposals(params) {
    ...
    return QueryProposalsResponse.fromJSON(await this.req.get(endpoint, options));
  }
  /* Vote queries voted information based on proposalID, voterAddr. */
  async vote(params) {
    const endpoint = `cosmos/gov/v1/proposals/${params.proposal_id}/votes/${params.voter}`;
    return QueryVoteResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async votes(params) {
    ...
    return QueryVotesResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async deposit(params) {
    ...
    return QueryDepositResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async deposits(params) {
    ...
    return QueryDepositsResponse.fromJSON(await this.req.get(endpoint, options));
  }
