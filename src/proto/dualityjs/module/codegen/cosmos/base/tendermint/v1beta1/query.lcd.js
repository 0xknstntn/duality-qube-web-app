...
import { GetNodeInfoResponse, GetSyncingResponse, GetLatestBlockResponse, GetBlockByHeightResponse, GetLatestValidatorSetResponse, GetValidatorSetByHeightResponse, ABCIQueryResponse } from "./query";
export class LCDQueryClient {
  ...
  async getLatestValidatorSet(params = {
    ...
    return GetLatestValidatorSetResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async getValidatorSetByHeight(params) {
    ...
    return GetValidatorSetByHeightResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async aBCIQuery(params) {
    ...
    return ABCIQueryResponse.fromJSON(await this.req.get(endpoint, options));
  }
}