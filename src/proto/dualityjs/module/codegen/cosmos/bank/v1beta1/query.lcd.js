...
import { QueryBalanceResponse, QueryAllBalancesResponse, QuerySpendableBalancesResponse, QuerySpendableBalanceByDenomResponse, QueryTotalSupplyResponse, QuerySupplyOfResponse, QueryParamsResponse, QueryDenomMetadataResponse, QueryDenomsMetadataResponse, QueryDenomOwnersResponse, QuerySendEnabledResponse } from "./query";
export class LCDQueryClient {
  ...
  async balance(params) {
    ...
    return QueryBalanceResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async allBalances(params) {
    ...
    return QueryAllBalancesResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async spendableBalances(params) {
    ...
    return QuerySpendableBalancesResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async spendableBalanceByDenom(params) {
    ...
    return QuerySpendableBalanceByDenomResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async totalSupply(params = {
    ...
    return QueryTotalSupplyResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async supplyOf(params) {
    ...
    return QuerySupplyOfResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async denomMetadata(params) {
    ...
    return QueryDenomMetadataResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async denomsMetadata(params = {
    ...
    return QueryDenomsMetadataResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async denomOwners(params) {
    ...
    return QueryDenomOwnersResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async sendEnabled(params) {
    ...
    return QuerySendEnabledResponse.fromJSON(await this.req.get(endpoint, options));
  }
}