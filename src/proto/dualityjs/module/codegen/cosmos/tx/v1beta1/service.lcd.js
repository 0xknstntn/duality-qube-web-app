...
import { GetTxResponse, GetTxsEventResponse, GetBlockWithTxsResponse } from "./service";
export class LCDQueryClient {
  ...
  async getTx(params) {
    ...
    return GetTxResponse.fromJSON(await this.req.get(endpoint));
  }
  ...
  async getTxsEvent(params) {
    ...
    return GetTxsEventResponse.fromJSON(await this.req.get(endpoint, options));
  }
  ...
  async getBlockWithTxs(params) {
    ...
    return GetBlockWithTxsResponse.fromJSON(await this.req.get(endpoint, options));
  }
}